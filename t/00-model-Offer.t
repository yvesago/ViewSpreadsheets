...
use_ok('ViewSpreadsheets::Model::Offer');
...
my $o = ViewSpreadsheets::Model::Offer->new(current_user => $system_user);
my ($id) = $o->create();
...
# Searches in general
my $collection =  ViewSpreadsheets::Model::OfferCollection->new(current_user => $system_user);
$collection->unlimit;
