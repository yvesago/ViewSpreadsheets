...
Jifty.DateTime = {
    ...
    toggleDateTime: function() {
        ...
        var start_weekday = 1; /* jQuery(this).hasClass('calendar-starts-monday') ? 1 : 0; */
...
/*        cal.cfg.setProperty("WEEKDAYS_SHORT", [_('Su'), _('Mo'), _('Tu'), _('We'), _('Th'), _('Fr'), _('Sa')]);
        cal.cfg.setProperty("MONTHS_LONG",    [_('January'), _('February'), "Mars", "Avril", "Mai", "Juin", "Juillet", _('August'), "Septembre", "Octobre", "Novembre", "D\u00e9cembre"]);
*/
        cal.cfg.setProperty("MONTHS_LONG",    ['Janvier', 'F\u00e9vrier', "Mars", "Avril", "Mai", "Juin", "Juillet", 'August', "Septembre", "Octobre", "Novembre", "D\u00e9cembre"]);
